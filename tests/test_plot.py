...
class TestPlot:
    ...
    def test_plot_one_line(self, dir_path, x, f):
        ''' plot y = x**2
        '''
        fig = plt.figure(
    ...
    def test_plot_one_line_legend(self, dir_path, x, f):
        '''
        '''
        fig = plt.figure(
            FigureClass=MyFigure,
    ...
    def test_plot_one_line_linestyle(self, dir_path, x, f):
        '''
        '''
        fig = plt.figure(
            FigureClass=MyFigure,
    ...
    def test_plot_one_line_scales(self, dir_path, x, f):
        '''
        '''
        fig = plt.figure(
            FigureClass=MyFigure,
    ...
    def test_plot_multiple_lines_legend(self, dir_path, x, f, g):
        '''
        '''
        fig = plt.figure(
            FigureClass=MyFigure,
    ...
    def test_plot_multiples_lines_scales(self, dir_path, x, f, g):
        '''
        '''
        fig = plt.figure(
            FigureClass=MyFigure,
